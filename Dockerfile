...
#start command:
#docker run -d --name db -p 27017:27017 -p 28017:28017 -v E:\docker\data\db:/data/db -e MONGODB_USER="nefadmin" -e M ONGODB_PASS="123456" -e MONGODB_DATABASE="nef"  tutum/mongodb